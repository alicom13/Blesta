...
$lang['Summary.index.term_years'] = '%1$s Anos';
$lang['Summary.index.term_year'] = '%1$s Ano';
$lang['Summary.index.term_months'] = '%1$s Meses';
$lang['Summary.index.term_month'] = '%1$s Mês';
$lang['Summary.index.term_weeks'] = '%1$s Semanas';
$lang['Summary.index.term_week'] = '%1$s Semana';
$lang['Summary.index.term_days'] = '%1$s Dias';
$lang['Summary.index.term_day'] = '%1$s Dia';
...
$lang['Summary.index.text_free_domain'] = 'Configure um pacote de %1$s por um mínimo de %2$s para se qualificar para um domínio gratuito.';
