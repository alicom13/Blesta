...
$lang['Summary.index.term_years'] = '%1$s Годы';
$lang['Summary.index.term_year'] = '%1$s Год';
$lang['Summary.index.term_months'] = '%1$s Месяцы';
$lang['Summary.index.term_month'] = '%1$s Месяц';
$lang['Summary.index.term_weeks'] = '%1$s Недели';
$lang['Summary.index.term_week'] = 'Неделя %1$s';
$lang['Summary.index.term_days'] = '%1$s Дни';
$lang['Summary.index.term_day'] = 'День %1$s';
...
$lang['Summary.index.text_free_domain'] = 'Настройте пакет %1$s на сумму не менее %2$s, чтобы получить право на бесплатный домен.';
